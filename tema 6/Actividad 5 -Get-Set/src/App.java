...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        CuentaCorriente p1 = new CuentaCorriente(DNI, nombreTitular, 0,"Mafre");
        ...
        do {
            ...
            System.out.println("4.Cambiar nombre de banco");
            ...
            if (opcion == 1) {
                ...
                if (sacar > p1.saldo) {
                    ...
                    System.out.println("Le quedan: 0 € en su cuenta");
                }
            } else if (opcion == 2) {
                ...
                System.out.println("Digame el nombre del banco al que cambio");
                String nuevoBanco = sc.nextLine();
                p1.nombreBanco = nuevoBanco;
            }else if (opcion == 5) {
                break;
            } else {
