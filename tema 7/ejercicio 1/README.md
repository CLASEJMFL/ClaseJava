Diseñar la clase Texto que gestiona una cadena de caracteres con las siguientes características:
...
Nota:
    Hacer uso de las clases LocalDate y LocalDateTime, que se usan para gestionar la fecha y la hora.